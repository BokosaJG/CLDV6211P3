...
namespace CLDVPart1.Controllers
{
    public class VenueController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var venues = await _context.Venue.FirstOrDefaultAsync(v => v.VenueID == id);
            if (venues == null) return NotFound();
        ...
        {
            var connectionString = "DefaultEndpointsProtocol=https;AccountName=practicejg;AccountKey=nslytYBohnaWNSJ37lEBkoqPQUvU8YM2sdc31PwnoY/QEcw0JOUuH4ETDaPJcPpYcpCp5wbm1v2S+AStB5A5mw==;EndpointSuffix=core.windows.net";
            var containerName = "cldv6211";
